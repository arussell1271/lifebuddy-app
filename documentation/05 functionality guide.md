...
| **Dynamic Question Set** | Questions are loaded based on the current context and the Advisor Type from the **Question Set Store**. | Examples: "What time did you go to bed last night?" (EXECUTE), or "What was the dominant feeling in your dream?" (CULTIVATE). |
