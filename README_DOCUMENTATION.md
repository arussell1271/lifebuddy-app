...
| **Build the Engine service** | [10 engine api reference.md`10 engine api reference.md) + [example_root_endpoint.py`engine/example_root_endpoint.py) | 20 min |
| **Build the App service** | [06 ui technical specifications.md`06 ui technical specifications.md) | 20 min |
| **Implement synthesis logic** | [07 engine logic specifications.md`07 engine logic specifications.md) | 25 min |
| **Set up the database** | [03 db_schema.sql`03 db_schema.sql) | 15 min |
| **Deploy to production** | [08 devops deployment guide.md`08 devops deployment guide.md) | 30 min |
| **Configure LLM prompts** | [09 llm prompts advisor config.md`09 llm prompts advisor config.md) | 20 min |
| **Understand business goals** | [01 project definition.md`01 project definition.md) | 10 min |
...
- ðŸ“„ [01 project definition.md`01 project definition.md) - Business goals, hypotheses (H1/H2/H3), user personas, philosophical framework

**System Architecture**
- ðŸ—ï¸ [02 infrastructure setup.md`02 infratructure setup.md) - Network isolation, service ports, Docker compose, environment variables
- ðŸ—„ï¸ [03 db_schema.sql`03 db_schema.sql) - Complete DDL with RLS policies, extensions (pgvector), constraints, triggers
...
- ðŸ“‹ [04 standards guide.md`04 standards guide.md) - Naming conventions, service responsibilities, RLS enforcement, JSON serialization, data retention policies

**User Flows** (Non-technical)
- ðŸ‘¥ [05 functionality guide.md`05 functionality guide.md) - Feature descriptions, user stories, business rules, interaction flows

**Frontend & API Contracts**
- ðŸŒ [06 ui technical specifications.md`06 ui technical specifications.md) - API endpoints, response schemas, daily check flow, async job polling, authentication, RLS enforcement

**Engine Synthesis Algorithm**
- ðŸ§  [07 engine logic specifications.md`07 engine logic specifications.md) - Synthesis workflow (Cultivateâ†’Executeâ†’Contribute), DFC calculation, H1/H2/H3 validation, job patterns
...
- ðŸš€ [08 devops deployment guide.md`08 devops deployment guide.md) - Local dev setup, backup/restore, health checks, production deployment, disaster recovery, security hardening

**LLM & Prompt Management**
- ðŸ’­ [09 llm prompts advisor config.md`09 llm prompts advisor config.md) - System prompts, advisor templates (Cultivator/Executor/Contributor), spiritual modes (TAROT/GOD/NEUTRAL), communication tones (GUIDANCE/MENTOR/EXPERT), user custom questions, admin control, prompt testing
...
- ðŸŽ¯ [ENGINE_ROOT_ENDPOINT_GUIDE.md`ENGINE_ROOT_ENDPOINT_GUIDE.md) - Step-by-step implementation guide, customization tips, troubleshooting, monitoring setup
...
### Product Manager
- ðŸ“„ [01 project definition.md`01 project definition.md) - Business goals, hypotheses
- ðŸ‘¥ [05 functionality guide.md`05 functionality guide.md) - User flows, features
- ðŸ“‹ [DOCUMENTATION_MANIFEST.md`DOCUMENTATION_MANIFEST.md) - Overall status

### Backend Engineer (Engine)
- ðŸ¤– [.github/copilot-instructions.md`.github/copilot-instructions.md) - Architecture, patterns
- ðŸ“¡ [10 engine api reference.md`10 engine api reference.md) - API endpoints
- ðŸ’» [example_root_endpoint.py`engine/example_root_endpoint.py) - Code template
- ðŸ§  [07 engine logic specifications.md`07 engine logic specifications.md) - Synthesis logic
- ðŸ—„ï¸ [03 db_schema.sql`03 db_schema.sql) - Database schema
- ðŸ’­ [09 llm prompts advisor config.md`09 llm prompts advisor config.md) - LLM integration

### Backend Engineer (App)
- ðŸ¤– [.github/copilot-instructions.md`.github/copilot-instructions.md) - Architecture, patterns
- ðŸŒ [06 ui technical specifications.md`06 ui technical specifications.md) - API contracts
- ðŸ“‹ [04 standards guide.md`04 standards guide.md) - Naming conventions
- ðŸ—„ï¸ [03 db_schema.sql`03 db_schema.sql) - Database schema

### Frontend Engineer
- ðŸ¤– [.github/copilot-instructions.md`.github/copilot-instructions.md) - Architecture overview
- ðŸŒ [06 ui technical specifications.md`06 ui technical specifications.md) - API contracts, response schemas
- ðŸ‘¥ [05 functionality guide.md`05 functionality guide.md) - User flows, UX requirements

### DevOps Engineer
- ðŸš€ [08 devops deployment guide.md`08 devops deployment guide.md) - Build, deploy, monitoring
- ðŸ—ï¸ [02 infrastructure setup.md`02 infratructure setup.md) - Network, containers, ports
- ðŸ“¡ [10 engine api reference.md`10 engine api reference.md) - Health checks, endpoints

### AI/ML Engineer
- ðŸ’­ [09 llm prompts advisor config.md`09 llm prompts advisor config.md) - Prompt templates, modifiers
- ðŸ§  [07 engine logic specifications.md`07 engine logic specifications.md) - Synthesis algorithm, DFC

### QA/Testing
- ðŸ‘¥ [05 functionality guide.md`05 functionality guide.md) - User flows, test scenarios
- ðŸŒ [06 ui technical specifications.md`06 ui technical specifications.md) - API endpoints, error codes
- ðŸ“¡ [10 engine api reference.md`10 engine api reference.md) - All endpoints to test

### System Administrator
- ðŸ—ï¸ [02 infrastructure setup.md`02 infratructure setup.md) - Ports, networks, env vars
- ðŸš€ [08 devops deployment guide.md`08 devops deployment guide.md) - Deployment, security, monitoring
...
3. **Verify** database schema in [03 db_schema.sql`03 db_schema.sql) matches your setup
4. **Validate** error codes in [DOCUMENTATION_MANIFEST.md`DOCUMENTATION_MANIFEST.md)
5. **Approve** prompt templates in [09 llm prompts advisor config.md`09 llm prompts advisor config.md)

### During Building (Implementation)
1. **Use** [example_root_endpoint.py`engine/example_root_endpoint.py) as code template
2. **Follow** [04 standards guide.md`04 standards guide.md) for naming/structure
3. **Reference** [06 ui technical specifications.md`06 ui technical specifications.md) for API contracts
4. **Update** docs immediately when code changes
5. **Log changes** in [DOCUMENTATION_MANIFEST.md`DOCUMENTATION_MANIFEST.md)

### After Building (Operations)
1. **Deploy** using [08 devops deployment guide.md`08 devops deployment guide.md)
2. **Monitor** health checks from [10 engine api reference.md`10 engine api reference.md)
3. **Test** synthesis logic against [07 engine logic specifications.md`07 engine logic specifications.md)
4. **Validate** LLM integration with [09 llm prompts advisor config.md`09 llm prompts advisor config.md)
...
| Question | Answer In |
|----------|-----------|
| "How does synthesis work?" | [07 engine logic specifications.md`07 engine logic specifications.md) |
| "What APIs does the Engine expose?" | [10 engine api reference.md`10 engine api reference.md) |
| "What error codes should I use?" | [.github/copilot-instructions.md`.github/copilot-instructions.md) (Error Handling section) |
| "How do I deploy this?" | [08 devops deployment guide.md`08 devops deployment guide.md) |
| "What's the database schema?" | [03 db_schema.sql`03 db_schema.sql) |
| "How do I modify prompts?" | [09 llm prompts advisor config.md`09 llm prompts advisor config.md) |
| "What's the business goal?" | [01 project definition.md`01 project definition.md) |
| "Which endpoints exist?" | [10 engine api reference.md`10 engine api reference.md) |
...
2. Read [01 project definition.md`01 project definition.md) (context)
...
2. [DOCUMENTATION_MANIFEST.md`DOCUMENTATION_MANIFEST.md) (context)
3. Feature-specific docs as needed

**For Code Review**:
1. [04 standards guide.md`04 standards guide.md) (naming, structure)
2. [06 ui technical specifications.md`06 ui technical specifications.md) (API patterns)
